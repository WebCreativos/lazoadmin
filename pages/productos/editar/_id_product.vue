            ...
            <v-col class="col-12 col-md-7">
              <v-row>
                <v-col class="col-12 col-md-6">
                  <formsFieldsTextComponent label="CODIGO" type="number" v-model="product.codigo" class="rounded-lg" solo dense>
                ...
                <v-col class="col-12 col-md-6">
                  ...
                  <formsFieldsTextComponent label="CANTIDAD" type="number" v-model="product.cantidad" class="rounded-lg" solo dense>
                  </formsFieldsTextComponent>
                  ...
                  <formsFieldsTextComponent label="FECHA DE COMPRA" type="date" v-model="product.fecha_compra" class="rounded-lg"
                    solo dense></formsFieldsTextComponent>
                  <formsFieldsTextComponent label="VENCIMIENTO" type="date" v-model="product.vencimiento" class="rounded-lg"
                    solo dense></formsFieldsTextComponent>
