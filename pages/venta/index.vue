                      ...
                      <v-menu ref="menu" class="calendar" v-model="menu" transition="scale-transition" offset-y
                        ...
                        <v-card>
                          ...
                          <v-card-actions>
                            ...
                            <v-btn text color="teal darken-3" @click="$refs.menu.save(menu)">OK</v-btn>
                          </v-card-actions>
                        </v-card>
                      </v-menu>
                    </v-col>
                    ...
                    <v-row>
                      <v-col class="col-md-12 col-12">
                        <v-input>
                          ...
                          <v-btn class="rounded-l-0 rounded-r-lg" height="40" color="teal darken-3"
                      ...
                      <v-col class="col-md-12 col-12">
                        <v-btn block color="teal darken-3" class="rounded-lg  font-weight-light white--text"
