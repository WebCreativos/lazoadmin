          ...
          <v-col class="col-md-4 col-12">
            <v-row>
              ...
              <v-col class="col-12 d-flex justify-space-between">
                <v-row>
                  <v-col class="col-6">
                    <v-btn block class="white--text" color="teal darken-3 font-weight-light rounded-lg" @click="()=>{
    ...
    <v-dialog v-model="listSociosModal">
      <SociosListSociosComponent icon v-model="sociosList" @changePage="getSocios($event)">
        <template v-slot:button="{ item }">
          <v-btn small class="my-3 teal darken-3 font-weight-light white--text" @click="setSocio(item)">
            AGREGAR
          </v-btn>
        </template>
        <template v-slot:extraFields>
          <v-row>
            ...
            <v-col class="col-md-2 col-12">
              <v-btn block depressed height="40" color="teal darken-3" @click="getSocios()">
