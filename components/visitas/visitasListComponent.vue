    ...
    <v-card-title>
      <v-row>
        <v-col class="col-md-7">
          <formsFieldsTextComponent solo dense v-model="search.search" prepend-inner-icon="mdi-account-search"
          ...
          <v-menu ref="menu" class="calendar" v-model="menu" transition="scale-transition" offset-y min-width="290px"
            ...
            <template v-slot:activator="{ on }">
              <div v-on="on" style="cursor:pointer">
                <formsFieldsTextComponent solo dense class="selectInput font-weight-light" :value="formatDate(search.fecha)"
