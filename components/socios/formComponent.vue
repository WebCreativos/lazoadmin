<template>
  <v-card class="rounded-xl">
        ...
        <v-row>
          ...
          <v-col class="col-12 col-md-12">
            <v-card outlined dense class="rounded-xl">
              <v-toolbar color="teal darken-3 white--text" elevation="0">
            ...
            <mascotasColoresComponent v-model="socio.mascotas[index].color"></mascotasColoresComponent>
              ...
              <v-card-title>
                <v-btn color="teal darken-3" v-if="socio.mascotas.length>1" depressed @click="deleteMascota()"
                  class="white--text font-weight-light rounded-lg mr-1">
                  Eliminar
                  <v-icon>mdi-minus</v-icon>
                </v-btn>
                <v-btn color="teal darken-3" class="white--text font-weight-light rounded-lg"
                  @click="addMascota()">
                  Agregar
    ...
    <v-card-actions>
      <v-spacer></v-spacer>
      <v-btn color="teal darken-3" class="mb-5 white--text font-weight-light" @click="checkHandler()">
        Guardar
      </v-btn>
    </v-card-actions>
