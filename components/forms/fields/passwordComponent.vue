<template>
  <div class="d-flex flex-column">
    ...
    <formsFieldsTextComponent prepend-inner-icon="mdi-lock"  class="rounded-lg font-weight-regular" :type="typeInput" :append-icon="appendIcon" @click:append="show = !show"
